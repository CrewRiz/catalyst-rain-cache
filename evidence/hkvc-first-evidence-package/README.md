...
- Use `CATALYST_USE_WRANGLER_OAUTH=1` with a logged-in Wrangler session, or provide `CLOUDFLARE_API_TOKEN`, to rerun the Cloudflare Workers AI smoke probe; expand beyond that before treating it as generation-quality evidence.
